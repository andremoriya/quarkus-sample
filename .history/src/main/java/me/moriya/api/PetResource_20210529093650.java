...
public class PetResource {
    ...
    @POST
    public Uni<Response> save(PetDTO pet)
    {
    ...
    @PUT
    @Path("/{id}")
    public Uni<Response> update(@RestPath Long id, Pet pet)
    {
        return Panache.withTransaction(
            () -> Pet.<Pet>findById(id).onItem().ifNotNull().invoke(entity -> entity.setName(pet.getName()))
